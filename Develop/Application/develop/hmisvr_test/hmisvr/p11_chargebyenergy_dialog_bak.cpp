...
void p11_chargebyenergy_dialog::number_ptbn_press()
{
    ...
    {
        array[num]->setStyleSheet("QPushButton{border-image: url(:/new/prefix/pic_resource/otherwidget/number.png);}\
                                  QPushButton:pressed{border-image: url(:/new/prefix/pic_resource/otherwidget/number_press.png);}");
    }
}
