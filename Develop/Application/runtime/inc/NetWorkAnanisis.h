...
#define DATATRANSFORM_BYHYALINE (1)     //����ת����

#define DATATRANSFORM_BYSOCKET (2)     //

#define DATATRANSFORM_BYWIFI (10)      //wifi

#define DATATRANSFORM_BYTDSCDMA_4G   (11)    //�ƶ�4G
#define DATATRANSFORM_BYTDSCDMA_3G   (12)    //�ƶ�3G  no use
#define DATATRANSFORM_BYTDSCDMA_2G   (13)    //�ƶ�2G  


#define DATATRANSFORM_BYWCDMA_4G     (14)    //��ͨ4G
#define DATATRANSFORM_BYWCDMA_3G     (15)    //��ͨ3G
#define DATATRANSFORM_BYWCDMA_2G     (16)    //��ͨ2G


#define DATATRANSFORM_BYCDMA2000_4G  (17)    //����4G
#define DATATRANSFORM_BYCDMA2000_3G  (18)    //����3G
#define DATATRANSFORM_BYCDMA2000_2G  (19)    //����2G   no use
...
struct _cmd_code_0x46//���׮�����ն˹�����������?
{
	...
	unsigned char CanSvrCellType;//�ͷ���������
	unsigned char Chr_GunNum;//���ǹ����?
	unsigned char ServerIp[4];//���ķ�������ַ
	unsigned char ServerPort[2];//���ķ������˿�
...
state manager
**************************/
struct _cmd_code_0x01//中心系统下达签到命令
{
	//用户ID
	short UerID;
	//指令序列
...
struct _cmd_code_0x10//中心系统查询签到应答 /
{
	//用户ID
	short  UerID;//BYTE=2
	//指令序列
...
struct _cmd_code_0x05//中心系统查询签到应答 /
{
	//用户ID
	short  UerID;//BYTE=2
	//指令序列
